...
class Sketch {
  ...
  scrollEvent() {
    this.clicker.addEventListener("scroll", () => {
      this.next();
    });
  }
  settings() {
  ...
  next() {
    const sections = document.querySelectorAll(".sections-to-render div");
    ...
    tl.to(this.material.uniforms.progress, this.duration, {
      ...
      onComplete: () => {
        ...
        console.log("FINISH");
        sections[this.current].style = "flex";
